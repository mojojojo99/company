...
<div>
<button style="margin-bottom: .5em" id="engTimelineButton" class="button special disabled" onclick="showEnglishTimeline(this)"> English 英文 </button>
<button id="chTimelineButton" class="button special"  onClick="showChineseTimeline(this)"> Chinese 中文 </button>
</div>
...
<span id="ch-timeline" style="display: none">
          <div class="js-timeline_item ag-timeline_item">
            <div class="ag-timeline-card_box">
              <div class="js-timeline-card_point-box ag-timeline-card_point-box">
                <div class="ag-timeline-card_point">1980</div>
